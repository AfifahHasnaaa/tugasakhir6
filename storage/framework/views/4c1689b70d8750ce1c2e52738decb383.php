...
<div class="dataalumni">
    ...
    <div class="row mb-3">
        <div class="col-md-12 d-flex justify-content-end">
            <a href="" class="btn btn-primary me-1" style="color: white;">Input Data</a><span><a href="<?php echo e(route('export.alumni')); ?>" class="btn btn-success" style="color: white;">Download Excel</a></span>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.adminLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinKpad\Downloads\baruuu\tracking-alumni (1)\resources\views/admin/dataalumni.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Data Alumni SMK N 1 Bantul'); ?>
...
<div class="dataalumni">
    ...
    <script>
        ...
        var tabel = $("#data-list").DataTable({
            ...
            "order": [
                [1, "asc"] // Ubah pengurutan berdasarkan Nama Alumni
            ],
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tracking-alumni\tracking-alumni\resources\views/guest/dataalumni.blade.php ENDPATH**/ ?>
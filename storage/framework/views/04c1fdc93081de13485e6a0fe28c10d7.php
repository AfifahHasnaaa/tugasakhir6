...
<div class="alumni">
    <div class="sidebar">
        ...
        <ul class="menu">
            ...
            <li class="<?php echo e(request()->routeIs(['prestasiuser','tambahprestasiuser','editprestasiuser']) ? 'active' : ''); ?>">
                <a href="<?php echo e(route('prestasiuser')); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.mainalumni', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinKpad\Downloads\baruuu\tracking-alumni (1)\resources\views/layout/alumniLayout.blade.php ENDPATH**/ ?>
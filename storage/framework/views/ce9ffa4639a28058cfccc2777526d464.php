    ...
    <div class="row container-fluid pt-2 pb-1 ">
        <div class="row align-items-center">
            ...
            <div class="col-3 logo-instansi text-end">
                ...
                <img src="<?php echo e(asset('storage/logo/' . $lowongan->logo)); ?>" alt="Logo <?php echo e($lowongan->nama_instansi); ?>" style="width: 150px; height: 150px; object-fit: contain;">
                <?php endif; ?>
            </div>
        </div>
        <div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tracking-alumni\tracking-alumni\resources\views/guest/detaillowongan.blade.php ENDPATH**/ ?>
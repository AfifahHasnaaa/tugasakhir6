...
<?php else: ?>
<script>
    window.location.href = "<?php echo e(route('login.admin')); ?>"; // Arahkan ke halaman login
</script>
<?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.mainadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tracking-alumni\tracking-alumni\resources\views/layout/adminLayout.blade.php ENDPATH**/ ?>
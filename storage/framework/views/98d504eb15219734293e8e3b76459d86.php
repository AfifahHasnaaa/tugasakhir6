...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Jika ada nilai yang diambil dari backend (format Y-m-d)
        if (currentDate) {
    ...
    $(document).ready(function() {
        ...
        function sendData() {
            ...
            // Validasi tambahan (status, alasan, pendidikan, pekerjaan) seperti sebelumnya
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Ketika tombol "Gabung ke Telegram" diklik, arahkan ke Telegram dan simpan data
                    ...
                    $.ajax(url_post, {
                        ...
                        success: function(data, status, xhr) {
                            ...
                            Swal.fire({
                                ...
                                // Redirect ke halaman biodata jika diperlukan
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.alumniLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tracking-alumni\tracking-alumni\resources\views/alumni/inputalumni.blade.php ENDPATH**/ ?>
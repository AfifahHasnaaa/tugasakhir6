...
<div class="detail-lowongan">
    <div class="row container-fluid pt-2 pb-1 ">
        ...
        <div class="col-3 logo-instansi text-end">
            ...
            <img src="<?php echo e(asset('storage/logo/' . $lowongan->logo)); ?>" alt="Logo <?php echo e($lowongan->nama_instansi); ?>" class="me-3">
            <?php else: ?>
        ...
        <div>
            <p>
                ...
                <span class="text-center pt-auto pb-auto">
                    <?php if($lowongan->gaji == 'Kompetitif' || $lowongan->gaji == 'UMR'): ?>
    ...
    <div>
        ...
        <ul>
            ...
            <?php if(trim($deskripsi) != ''): ?> <!-- pastikan tidak menampilkan list kosong -->
    ...
    <div class="detail-button">
        <form id="hapus-form-<?php echo e($lowongan->id_lowongan); ?>" action="<?php echo e(route('lowongandata.destroy', $lowongan->id_lowongan)); ?>" method="POST" style="display: none;">
            <?php echo csrf_field(); ?>
            <?php echo method_field('DELETE'); ?>
        </form>

        <button class="btn btn-danger" onclick="hapusLowongan('<?php echo e($lowongan->id_lowongan); ?>')">
            Hapus
        </button>
        <button class="edit"><a href="<?php echo e(url('lowongan/edit/' . $lowongan->id_lowongan)); ?>">Edit</a></button>
    </div>
</div>
...
<?php echo $__env->make('layout.adminLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tracking-alumni\tracking-alumni\resources\views/admin/detaillowongan.blade.php ENDPATH**/ ?>
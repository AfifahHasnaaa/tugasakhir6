            ...
            <li>
                ...
                <ul id="lowongan" class="submenu-content collapse">
                    ...
                    <li class="<?php echo e(request()->routeIs('lamaran') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('lamaran', $alumnii->id_alumni)); ?>"><span class="icon"><i class='bi bi-circle'></i></span>Lamaran dan CV</a>
                    </li>
                </ul>
            </li>
            <li>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.mainalumni', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ThinKpad\Downloads\tracking-alumni (1)\resources\views/layout/alumniLayout.blade.php ENDPATH**/ ?>
...
<body>
    <div class="form-containet">
        ...
        <div class="col col-2">
            <div class="btn-box">
                <button class="btn btn-2" id="userButton"><a href="<?php echo e(route('login')); ?>">Alumni</a></button>
                <button class="btn btn-1" id="adminButton" style="background-color: #254e7a;"><a href="<?php echo e(route('login.admin')); ?>">Admin</a></button>
            </div>
            <!-- Form Login Alumni -->
            <form id="userForm" action="<?php echo e(route('login.alumni.process')); ?>" method="POST" class="login-user-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-inputs">
                    ...
                    <div class="input-box">
                        <input id="password" name="password" type="password" class="input-fields" value="<?php echo e(old('password')); ?>" placeholder="Kata Sandi" required>
                    ...
                    <div class="forget-pass">
                        <p id="loginText">Belum Punya Akun? <a href="<?php echo e(route('register')); ?>">Daftar</a></p>
                    </div>
                </div>
            </form>
        </div>
...
</script><?php /**PATH C:\Users\ThinKpad\Downloads\baruuu\tracking-alumni (1)\resources\views/login.blade.php ENDPATH**/ ?>
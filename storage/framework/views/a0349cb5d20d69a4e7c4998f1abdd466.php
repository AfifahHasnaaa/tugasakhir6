    ...
    document.querySelectorAll('input[name="gaji"]').forEach((elem) => {
        elem.addEventListener('change', function() {
            ...
            if (this.value === 'Gaji Sendiri') {
                inputGajiSendiri.style.display = 'block';
                jumlahGajiSendiri.setAttribute('name', 'gaji');
                jumlahGajiSendiri.required = true;
            } else {
                inputGajiSendiri.style.display = 'none';
                jumlahGajiSendiri.removeAttribute('name');
                jumlahGajiSendiri.required = false;
            }
        });
    });
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.adminLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Documents\tracking-alumni\resources\views/admin/tambahlowongan.blade.php ENDPATH**/ ?>
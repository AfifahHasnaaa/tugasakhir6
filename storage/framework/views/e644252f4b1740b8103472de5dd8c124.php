...
<div class="dataalumni">
    ...
    <div class="row mb-3">
        <div class="col-md-12 d-flex justify-content-end">
            <a href="<?php echo e(route('export.alumni')); ?>" class="btn btn-success" style="color: white;">Download Excel</a>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Update jumlah entri per halaman
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.adminLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tracking-alumni\tracking-alumni\resources\views/admin/dataalumni.blade.php ENDPATH**/ ?>
    ...
    <div class="container-fluid d-md-flex align-items-center">
        <div class="welcome text-center text-md-center">
            ...
            <div class="group-button">
                <button class="formalumni-btn"><a href="{{ route('formalumni') }}">Form Alumni</a></button>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="progress-box" data-aos="zoom-in" data-aos-delay="20">
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <h3 id="jumlahAlumni" class="mb-1">{{$totalLakiLaki}}</h3>
        ...
        <div class="col-md-4">
            <div class="progress-box" data-aos="zoom-in" data-aos-delay="20">
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <h3 id="jumlahAlumni" class="mb-1">{{$totalPerempuan}}</h3>

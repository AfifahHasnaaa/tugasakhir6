                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_alumni" class="form-control form-user-input" id="namaLengkap" placeholder="Masukkan nama lengkap" required="" value="{{ $alumni->nama_alumni }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">
                                NIS<span style="color: red; font-weight:bold">*</span>
                            </label>
                            <input type="text" name="nis" class="form-control form-user-input" id="nis" placeholder="Masukkan NIS" required="" value="{{ $alumni->nis }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">
                                NISN<span style="color: red; font-weight:bold">*</span>
                            </label>
                            <input type="text" name="nisn" class="form-control form-user-input" id="nisn" placeholder="Masukkan NISN" required="" value="{{ $alumni->nisn }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">
                                Tempat Lahir<span style="color: red; font-weight:bold">*</span>
                            </label>
                            <input type="text" name="tempat_lahir" class="form-control form-user-input" id="tempatLahir" placeholder="Masukkan tempat lahir" required="" value="{{ $alumni->tempat_lahir }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">
                                Tanggal Lahir<span style="color: red; font-weight:bold">*</span>
                            </label>
                            <input type="date" name="tanggal_lahir" class="form-control form-user-input" id="tanggalLahir" required="" value="{{ $alumni->tanggal_lahir ? \Carbon\Carbon::parse($alumni->tanggal_lahir)->format('Y-m-d') : '' }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-select form-user-input" id="jenisKelamin" name="gender">
                                <option disabled selected {{ is_null($alumni->gender) ? 'selected' : '' }}>Pilih jenis kelamin</option>
                                <option value="L" {{ $alumni->gender === 'L' ? 'selected' : '' }}>Laki-laki</option>
                                <option value="P" {{ $alumni->gender === 'P' ? 'selected' : '' }}>Perempuan</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" required="">
                            ...
                            <select class="form-select form-user-input" id="agama" name="agama">
                                <option disabled selected {{ is_null($alumni->agama) ? 'selected' : '' }}>Pilih agama</option>
                                <option value="Islam" {{ $alumni->agama === 'Islam' ? 'selected' : '' }}>Islam</option>
                                <option value="Kristen" {{ $alumni->agama === 'Kristen' ? 'selected' : '' }}>Kristen</option>
                                ...
                                <option value="Budha" {{ $alumni->agama === 'Budha' ? 'selected' : '' }}>Budha</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-user-input" id="status" name="status" onchange="toggleAlasanInput()">
                                ...
                                <option value="Belum Bekerja" {{ $alumni->status === 'Belum Bekerja' ? 'selected' : '' }}>Belum Bekerja</option>
                                <option value="Wirausaha" {{ $alumni->status === 'Wirausaha' ? 'selected' : '' }}>Wirausaha</option>
                                <option value="Pendidikan Lanjut" {{ $alumni->status === 'Pendidikan Lanjut' ? 'selected' : '' }}>Pendidikan Lanjut</option>
                        ...
                        <div id="alasanContainer" class="mb-3">
                            ...
                            <input type="text" name="alasan" class="form-control form-user-input" id="alasan" placeholder="contoh : ibu rumah tangga" value="{{ $alumni->alasan ?? '' }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control form-user-input" name="alamat_tinggal" id="alamat_tinggal" rows="3" placeholder="Masukkan alamat" required="">{{ $alumni->alamat }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control form-user-input" name="alamat_domisili" id="alamat_domisili" rows="3" placeholder="Masukkan alamat" required="">{{$alumni->alamat_domisili}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control form-user-input" name="tahun_masuk" id="tahunMasuk" placeholder="Masukkan tahun masuk" required="" value="{{ $alumni->tahun_masuk }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">
                                Tahun Lulus<span style="color: red; font-weight:bold">*</span>
                            </label>
                            <input type="number" class="form-control form-user-input" name="tahun_lulus" id="tahunLulus" placeholder="Masukkan tahun lulus" required="" value="{{ $alumni->tahun_lulus }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">
                            ...
                            <select class="form-select form-user-input" id="jurusansmk" name="jurusan_smk">
                                <option disabled selected {{ is_null($alumni->jurusan) ? 'selected' : '' }}>Pilih jurusan SMK</option>
                                <option value="Akuntansi" {{ $alumni->jurusan === 'Akuntansi' ? 'selected' : '' }}>Akuntansi</option>
                                <option value="Layanan Perbankan Syariah" {{ $alumni->jurusan === 'Layanan Perbankan Syariah' ? 'selected' : '' }}>Layanan Perbankan Syariah</option>
                                <option value="Bisnis Daring dan Pemasaran" {{ $alumni->jurusan === 'Bisnis Daring dan Pemasaran' ? 'selected' : '' }}>Bisnis Daring dan Pemasaran</option>
                                <option value="Otomasisasi Perkantoran" {{ $alumni->jurusan === 'Otomasisasi Perkantoran' ? 'selected' : '' }}>Otomasisasi Perkantoran</option>
                                <option value="Desain Komunikasi Visual" {{ $alumni->jurusan === 'Desain Komunikasi Visual' ? 'selected' : '' }}>Desain Komunikasi Visual</option>
                ...
                <div class="card mb-3" id="pendidikanContainer">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-user-input" name="universitas" id="universitas" placeholder="Masukkan nama universitas" value="{{ $alumni->perguruan_tinggi }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Prodi</label>
                            <input type="text" class="form-control form-user-input" name="prodi" id="prodi" placeholder="Masukkan prodi" value="{{ $alumni->prodi }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3" id="pekerjaanContainer">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-user-input" name="nama_perusahaan" id="namaPerusahaan" placeholder="Masukkan nama perusahaan" value="{{ $alumni->nama_perusahaan }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Bidang Pekerjaan/Usaha</label>
                            <input type="text" class="form-control form-user-input" name="bidang_pekerjaan" id="bidang" placeholder="Masukkan bidang pekerjaan" value="{{ $alumni->bidang_pekerjaan }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Jabatan/Posisi</label>
                            <input type="text" class="form-control form-user-input" name="jabatan" id="jabatan" placeholder="Masukkan jabatan" value="{{ $alumni->jabatan }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Penghasilan Bulanan</label>
                            <input type="text" class="form-control form-user-input" name="penghasilan" id="penghasilan" placeholder="Masukkan penghasilan bulanan" value="{{ $alumni->penghasilan }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Alamat Instansi</label>
                            <textarea class="form-control form-user-input" name="alamat_instansi" id="alamat_instansi" rows="3" placeholder="Masukkan Alamat">{{ $alumni->alamat_instansi }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-user-input" name="no_telepon" id="notelpon" placeholder="Masukkan nomor telepon" required="" value="{{ $alumni->no_telepon }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">No Telepon Alternatif</label>
                            <input type="text" class="form-control form-user-input" name="no_telepon_alternatif" id="notelponal" placeholder="Masukkan nomor telepon alternatif" value="{{ $alumni->no_telepon_alternatif }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">
                                Email<span style="color: red; font-weight:bold">*</span>
                            </label>
                            <input type="email" class="form-control form-user-input" name="email" id="email" placeholder="Masukkan email" required="" value="{{ $alumni->email }}">
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        function sendData() {
            var url_post = '{{ url("/editbiodataupdate") }}';
            var dataForm = {};
    ...
    ambil_provinsi_tinggal('{{ $alumni->provinsi }}')
        .then(selectedProvinsiValue => ambil_kabupaten_tinggal(selectedProvinsiValue, '{{ $alumni->kabupaten }}'))
        .then(selectedKabupatenValue => ambil_kecamatan_tinggal(selectedKabupatenValue, '{{ $alumni->kecamatan }}'))
        .then(selectedKecamatanValue => ambil_kelurahan_tinggal(selectedKecamatanValue, '{{ $alumni->kelurahan }}'))
    ...
    ambil_provinsi_domisili('{{ $alumni->provinsi_domisili }}')
        .then(selectedProvinsiValue => ambil_kabupaten_domisili(selectedProvinsiValue, '{{ $alumni->kabupaten_domisili }}'))
        .then(selectedKabupatenValue => ambil_kecamatan_domisili(selectedKabupatenValue, '{{ $alumni->kecamatan_domisili }}'))
        .then(selectedKecamatanValue => ambil_kelurahan_domisili(selectedKecamatanValue, '{{ $alumni->kelurahan_domisili }}'))
        .catch(error => console.log(error));

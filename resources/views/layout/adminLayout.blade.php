    ...
    <div class="sidebar">
        ...
        <div class="profile-section">
            <div class="profile-picture">
                <img id="admin-photo" src="{{ Auth::guard('admin')->user()->foto ? asset('asset/profil/' . Auth::guard('admin')->user()->foto) : asset('asset/profil/Blank Profile.png') }}" alt="Profile">
                <div class="camera-icon">
                    <i class="bx bx-camera icon" onclick="document.getElementById('upload-photo').click();"></i>
                </div>
            </div>
            <form id="photo-form" action="{{ route('admin.updatePhoto') }}" method="POST" enctype="multipart/form-data" style="display:none;">
                @csrf
        ...
        <ul class="menu">
            ...
            <li class="{{ request()->routeIs(['dataalumniadmin','detailalumni']) ? 'active' : '' }}">
                <a href="{{ route('dataalumniadmin') }}">
            ...
            <li>
                ...
                <ul id="lowongan" class="submenu-content collapse">
                    <li class="{{  request()->routeIs(['lowonganadmin', 'detaillowonganadmin']) ? 'active' : ''}}">
                        <a href="{{ route('lowonganadmin') }}"><span class="icon"><i class='bi bi-circle'></i></span>Lowongan</a>
                    </li>
                    <li class="{{ request()->routeIs('tambahlowongan') ? 'active' : '' }}">
                        <a href="{{ route('tambahlowongan') }}"><span class="icon"><i class='bi bi-circle'></i></span>Tambah Lowongan</a>
                    </li>
                </ul>
            </li>
            <li class="{{ request()->routeIs(['prestasi','tambahprestasi','editprestasi']) ? 'active' : '' }}">
            ...
            <li class="{{ request()->routeIs(['profileadmin','editprofileadmin','editpasswordadmin']) ? 'active' : '' }}">
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    ...
                    icon: "success"
                }).then(() => window.location.href = "{{ route('keluar') }}");
            }
        });
    }
</script>

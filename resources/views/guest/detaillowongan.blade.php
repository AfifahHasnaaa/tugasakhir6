...
<div class="detail-lowongan">
    <div class="row container-fluid pt-2 pb-1 ">
        <div class="row align-items-center">
            ...
            <div class="col-3 logo-instansi text-end">
                @if($lowongan->logo)
                <img src="{{ asset('storage/logo/' . $lowongan->logo) }}" alt="Logo {{ $lowongan->nama_instansi }}" style="width: 150px; height: 150px; object-fit: contain;">
                @endif
            </div>
        </div>
        <div>
    ...
    <div>
        ...
        <ul>
            ...
            @if(trim($deskripsi) != '') <li>{{ $deskripsi }}</li>
            @endif
            @endforeach
        </ul>
    </div>

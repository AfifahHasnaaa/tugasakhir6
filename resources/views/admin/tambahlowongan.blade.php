...
@section('title','Tambah Lowongan - SMKN 1 Bantul')
...
<script>
    $(document).ready(function() {
        ...
        function sendData() {
            var url_post = '{{ url("api/lowongan/input") }}';
            var formData = new FormData();

            formData.append('id_user_admin', '{{ Auth::guard("admin")->id() }}');

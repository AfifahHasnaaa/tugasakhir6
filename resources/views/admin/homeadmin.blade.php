...
@section('title', 'Tracking Alumni SMK N 1 Bantul')
                ...
                <div class="card text-white" style="background-color: #003366;">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            <h3 id="jumlahAlumni" class="mb-1">{{$totalAlumni}}</h3>
            ...
            <div class="col-md-4">
                <div class="card bg-success text-white">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            <h3 id="jumlahAlumni" class="mb-1">{{$totalBekerja}}</h3>
            ...
            <div class="col-md-4">
                <div class="card bg-warning text-white">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            <h3 id="jumlahAlumni" class="mb-1">{{$totalWirausaha}}</h3>
            ...
            <div class="col-md-4">
                <div class="card text-white" style="background-color: #6f42c1;">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            <h3 id="jumlahAlumni" class="mb-1">{{$totalKuliah}}</h3>
            ...
            <div class="col-md-4">
                <div class="card text-white" style="background-color: #FFA500;">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            <h3 id="jumlahAlumni" class="mb-1">{{$totalBelumBekerja}}</h3>
            ...
            <div class="col-md-4">
                <div class="card bg-danger text-white">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            <h3 id="jumlahAlumni" class="mb-1">{{$totalTidakBekerja}}</h3>
    ...
    <div class="container-fluid">
        <div class="container d-flex flex-column align-items-start mb-3">
            <div class="d-flex gap-3 mb-3 w-100">
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <input class="form-control" type="number" id="tahun_awal" value="{{ now()->year - 3 }}" style="width: 150px;" />
                </div>
                <div class="d-flex gap-2 align-items-center">
                    <label for="tahun_akhir" style="font-weight: 600;">Tahun Akhir :</label>
                    <input class="form-control" type="number" id="tahun_akhir" value="{{ now()->year }}" style="width: 150px;" />
                </div>
            </div>
        ...
        <div class="container d-flex flex-column align-items-start mb-3">
            <div class="d-flex gap-3 align-items-center mb-3">
                ...
                <input class="form-control" type="number" id="tahun" value="{{ now()->year }}" style="width: 150px;" />
            </div>

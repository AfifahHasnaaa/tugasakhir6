...
<div class="dataalumni">
    ...
    <div class="row mb-3">
        <div class="col-md-12 d-flex justify-content-end">
            <a href="#" class="btn btn-primary me-1" style="color: white;">Input Data</a> <span><a href="{{ route('export.alumni') }}" class="btn btn-success" style="color: white;">Download Excel</a></span>
        </div>
    </div>

...
<body>
    <div class="form-containet">
        ...
        <div class="col col-2">
            <div class="btn-box">
                <button class="btn btn-2" id="userButton" style="background-color: #254e7a;"><a href="{{ route('login') }}">Alumni</a></button>
                <button class="btn btn-1" id="adminButton"><a href="{{ route('login.admin') }}">Admin</a></button>
            </div>

            <!-- Form Login Admin-->
            <form id="adminForm" action="{{ route('login.admin.process') }}" method="POST" class="login-admin-form">
                @csrf
                ...
                <div class="form-inputs">
                    ...
                    <div class="input-box">
                        <input id="password" name="password" type="password" class="input-fields" placeholder="Kata Sandi" value="{{ old('password') }}" required>
